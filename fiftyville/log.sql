-- find crime scene desecription.
select desecription from crime_scene_reports
where month=7 and day=28 and steet like '%Humphrey Street';
-- POINTS:
-- Crime took place at 10:15am
-- Everyone mentioned bakery

--Q2:check for the date of the interview
select name ,transcript from interviews when year=2023 and month=7 and day=28
